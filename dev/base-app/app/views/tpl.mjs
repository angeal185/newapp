...
const tpl = {
  ...
  topbar(router){
    ...
    let item = x('nav', {class: 'navbar navbar-header navbar-expand navbar-light'},
      ...
      x('div', {class: 'title-text'}, xdata.app.name)
    )
  ...
  mdlCreate(fn){
    ...
    item = x('div', {class: 'modal', id: 'create'},
      x('div', {class: 'modal-dialog modal-xl'},
        x('div', {class: 'modal-content'},
          x('div', {class: 'modal-body'},
            x('h3', 'Create Todo'),
          ...
          x('div', {class: 'modal-footer'},
            ...
            x('button', {
              ...
              onclick(){
                ...
                if(inp.value && txta.value && typeof obj === 'object'){
                  fn(obj);
                  inp.value = txta.value = '';
                  return cls.click();
                } else {
                  let evt = new CustomEvent('toasty', {detail: {data: 'Invalid input', sel: 'danger'}});
                  window.dispatchEvent(evt);
